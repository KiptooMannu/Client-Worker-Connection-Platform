      ...
      <main class="animate-in fade-in duration-1000">
        ...
        <section class="py-24 md:py-32 bg-slate-50 relative overflow-hidden">
          <div class="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8 relative z-10">
              <span class="inline-flex items-center gap-2 px-4 py-1.5 bg-brand-teal-soft text-brand-teal rounded-full text-[10px] font-black uppercase tracking-[0.2em] border border-brand-teal/10 shadow-sm">
                <mat-icon class="!text-[14px]">psychology</mat-icon>
                Custom Tailored Solutions
              </span>
              <h1 class="text-6xl font-black text-slate-900 tracking-tighter leading-tight">Staffing Solutions <br> For <span class="text-brand-teal underline decoration-4 underline-offset-8">Every Industry</span></h1>
              ...
              <div class="flex flex-wrap gap-4 pt-4">
                <div class="flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-slate-100 shadow-sm">
                  <mat-icon class="text-brand-teal">done_all</mat-icon>
            ...
            <div class="relative group">
              ...
              <!-- Floating Badge -->
              <div class="absolute -top-8 -right-8 w-32 h-32 bg-brand-teal rounded-full flex flex-col items-center justify-center text-white text-center p-4 shadow-2xl animate-bounce-slow">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              @for (item of solutions; track item.title) {
                <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
                  <div class="w-14 h-14 bg-slate-50 rounded-2xl flex items-center justify-center text-slate-400 group-hover:bg-brand-teal-soft group-hover:text-brand-teal transition-colors mb-6 shadow-inner">
        ...
        <section class="py-24 bg-slate-900 text-white overflow-hidden">
          <div class="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
            <div class="space-y-4">
              <div class="text-5xl font-black text-brand-teal mb-6 opacity-40 italic">01.</div>
            ...
            <div class="space-y-4">
              <div class="text-5xl font-black text-brand-teal mb-6 opacity-40 italic">02.</div>
