      ...
      <main class="animate-in fade-in duration-1000">
        ...
        <section class="relative py-24 md:py-32 overflow-hidden">
          <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 text-center">
            <span class="inline-flex items-center gap-2 px-4 py-1.5 bg-indigo-50 text-indigo-600 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-8 border border-indigo-100 shadow-sm">
              <mat-icon class="!text-[14px]">corporate_fare</mat-icon>
              Enterprise Grade Talent
            </span>
            <h1 class="text-6xl md:text-8xl font-black text-slate-900 tracking-tighter leading-tight mb-8">Scale Your Workforce <br class="hidden md:block"> <span class="text-indigo-600">Without Friction</span></h1>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button class="w-full sm:w-auto bg-slate-900 text-white px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-slate-900/20 hover:bg-indigo-600 active:scale-95 transition-all">Request a Demo</button>
          ...
          <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 opacity-30">
            <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-200 rounded-full blur-[120px] animate-pulse"></div>
            <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-100 rounded-full blur-[120px] animate-pulse"></div>
          </div>
        </section>
          ...
          <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div class="space-y-6 group">
                <div class="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500 shadow-sm">
        ...
        <!-- CTA Section -->
        <section class="py-24 bg-indigo-950 text-white">
          <div class="max-w-5xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-black tracking-tight mb-8">Ready to transform your enterprise operations?</h2>
            <p class="text-indigo-200 text-lg font-medium mb-12">Join over 200+ organizations leveraging Kazi Konnect for their professional labor needs.</p>
            <button class="bg-indigo-600 text-white px-12 py-5 rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-indigo-600/40 hover:bg-white hover:text-indigo-950 transition-all">Talk to an Expert</button>
          </div>
        </section>
      </main>
    </div>
