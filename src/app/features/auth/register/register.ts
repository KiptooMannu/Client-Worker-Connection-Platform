      ...
      <main class="flex-grow flex items-center justify-center p-6">
        <div class="w-full max-w-xl bg-white rounded-[2.5rem] p-12 shadow-[0_8px_48px_rgba(4,22,39,0.08)] border border-slate-100">
          <div class="text-center mb-10">
            <h1 class="text-3xl font-black text-[#041627] tracking-tight mb-2">Join the Marketplace</h1>
          ...
          <form (submit)="onSubmit()" class="space-y-8">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div (click)="role = 'Client'" 
                     [ngClass]="role === 'Client' ? 'border-blue-600 bg-blue-50 ring-2 ring-blue-600/10' : 'border-slate-100 bg-white'"
                ...
                <div (click)="role = 'Worker'" 
                  ...
                  <div>
                    <p class="text-sm font-black text-[#041627]">Worker</p>
            ...
            <button type="submit" [disabled]="loading()"
                    class="w-full bg-[#041627] text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest active:scale-95 transition-all shadow-xl shadow-slate-900/10 hover:shadow-2xl cursor-pointer">
...
export class RegisterPage {
  ...
  onSubmit() {
    ...
    setTimeout(() => {
      ...
      this.snackBar.open('Registration Successful! Welcome abroad.', 'Dismiss', {
        duration: 4000,
